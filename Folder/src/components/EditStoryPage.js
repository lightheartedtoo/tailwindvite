...
const EditStoryPage = ({ story, onSubmit, onCancel }) => {
  ...
  return (
    <div className="max-w-4xl mx-auto">
      ...
      <div className="text-center mb-8">
        <h1 className="text-4xl font-bold text-gray-800 mb-2">✏️ Edit Story</h1>
        <p className="text-gray-600">Update your story details</p>
      </div>
